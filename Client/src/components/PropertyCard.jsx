    ...
    return (
        <div className="flex flex-col overflow-hidden">
            ...
            <div className="content basis-[20%] text-start mt-2">
                <p className="text-xl font-normal flex justify-between gap-[3px]"><span className="text-base text-ellipsis whitespace-nowrap overflow-hidden font-semibold">{stay.listing.title}</span><span className="text-sm whitespace-nowrap">{stay.listing.avgRatingLocalized}</span></p>
                <p className="font-light leading-4 whitespace-nowrap text-ellipsis overflow-hidden text-gray-700 pb-1">{stay.listing.name}</p>
